...
createServer({
    ...
    routes() {
        ...
        // htis is to stop Mirage intercepting legit requests we are trying to send to firestore. It "whitelists" any requests to the given API
